...
public class IBSGetUIMeetingsTest extends TestBase{
	...
	public void setUP() throws ClientProtocolException, IOException {
		setupLog();
		loggerTest = extent.createTest("UIMeetings");
		loggerTest.info("UI Display - Meetings");
		auth.IBSLogin();
...
//		System.out.println(baseURLAdmin);
	...
	public void responseBodyTest(String serviceURL, String ContentTyp, String Accept, String XTenant, String payload) throws ParseException{	
		...
		loggerTest.assignCategory("UI Display - Meetings");
...
//	@Test(dataProvider = "GETData")
//	public void sample(String serviceURL, String ContentTyp, String Accept, String XTenant, String payload) {
//		String accessToken = auth.accessToken;
//		
...
//		extent.flush();
	...
	public String[][] getAPIData() throws IOException{
		String data[][] = get.getAPIPostData("UIMeetings");
		return data;	
	}
