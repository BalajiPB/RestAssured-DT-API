...
public class IBSGetUITranscriptsTest extends TestBase{
	...
	public void setUP() throws ClientProtocolException, IOException {
		...
		loggerTest.info("UI Display - Transcripts");
		auth.IBSLogin();
	...
	public void responseBodyTest(String serviceURL, String ContentTyp, String Accept, String XTenant, String payload) throws ParseException{	
		...
		loggerTest.assignCategory("UI Display - Transcripts");
...
//		extent.flush();
	...
	public String[][] getAPIData() throws IOException{
		String data[][] = get.getAPIPostData("UITranscripts");
		return data;	
	}
